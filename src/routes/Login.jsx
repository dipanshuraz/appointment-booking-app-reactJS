...
export class Login extends Component {
  ...
  handleClick = async () => {
    ...
    if (this.state.logUser.log_email !== '' && this.state.logUser.log_user !== '' && this.state.logUser.log_type !== '') {
  ...
  handleChange = e => {
    let obj = { ...this.state.logUser, [e.target.name]: e.target.value }
  ...
  render() {
    ...
    return (
      <>
        {this.props.isAuth ? (<Redirect to='/dash' />) : <div className="container mt-5">
